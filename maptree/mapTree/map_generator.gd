...
func _get_random_starting_points() -> Array[int]:
    ...
    while unique_points < 3:
        ...
        for i in PATHS:
            var starting_points := randi_range(0, MAP_WIDTH -1)
...
func _setup_random_room_weights() -> void:
    ...
    random_room_type_weights[Room.Type.EVENT] = FIGHT_ROOM_WEIGHT + EVENT_ROOM_WEIGHT
    random_room_type_weights[Room.Type.SHOP] = FIGHT_ROOM_WEIGHT + EVENT_ROOM_WEIGHT + SHOP_ROOM_WEIGHT
...
func _room_has_parents_of_type(room: Room, type: Room.Type) -> bool:
...
func _get_random_room_type_by_weights() -> Room.Type:
